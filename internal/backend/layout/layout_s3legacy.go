...
var s3LayoutPaths = map[rest.FileType]string{
	rest.PackFile:     "data",
	rest.SnapshotFile: "snapshot",
...
func (l *S3LegacyLayout) Dirname(h rest.Handle) string {
...
func (l *S3LegacyLayout) Filename(h rest.Handle) string {
	name := h.Name
...
func (l *S3LegacyLayout) Basedir(t rest.FileType) (dirname string, subdirs bool) {
